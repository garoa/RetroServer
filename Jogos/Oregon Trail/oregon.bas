...
420  INPUT A
425  IF (A >= 200) GOTO 440
430  PRINT "NOT ENOUGH"
435  GOTO 415
440  IF (A <= 300) GOTO 455
445  PRINT "TOO MUCH"
450  GOTO 415
...
600  PRINT
605  GOTO 1000
700  IF (M >= 2040 OR D3>17) GOTO 4000
709  REM ***SETTING DATE***
710  D3=D3+1
713  X$=INKEY$
715  CLEAR SCREEN
720  PRINT "MONDAY ";
725  IF (D3>10) GOTO 735
...
1000  IF (F >= 0) GOTO 1015
1010  F=0
1015  IF (B >= 0) GOTO 1025
1020  B=0
1025  IF (C >= 0) GOTO 1035
1030  C=0
1035  IF (M1 >= 0) GOTO 1045
1040  M1=0
1045  IF (F >= 12) GOTO 1055
...
1355  INPUT X
1360  IF (X=1) GOTO 1370
1365  X=2
1370  X=X+1
1375  IF (X=3) GOTO 1395
1380  IF (B>39) GOTO 1395
...
1515  GOTO 1555
1520  INPUT P
1525  IF (P<0) GOTO 1550
1530  T=T-P
1535  IF (T >= 0) GOTO 1550
...
2155  IF (RAN(100)>20) GOTO 2165
2160  S5=1-S5
2165  INPUT T1
2170  IF (T1<1) GOTO 2140
2175  IF (T1>4) GOTO 2140
2180  T1=INT(T1)
2185  IF (S5=1) GOTO 2330
2190  IF (T1>1) GOTO 2220
2195  M=M+20
2200  M1=M1-15
2205  B=B-150
2210  A=A-40
2215  GOTO 2395
2220  IF (T1>2) GOTO 2285
2225  GOSUB 4500
2230  B=B-B1*40-80
2235  IF (B1>1) GOTO 2250
2240  PRINT "NICE SHOOTING---YOU DROVE THEM OFF"
2245  GOTO 2395
2250  IF (B1 <= 4) GOTO 2275
...
2280  GOTO 2395
2285  IF (T1>3) GOTO 2310
2290  IF (RAN(100)>80) GOTO 2390
2295  B=B-150
2300  M1=M1-15
2305  GOTO 2395
2310  GOSUB 4500
...
2510  R1=RAN(100)
2515  D1=D1+1
2520  IF (D1=16) GOTO 3020
2525  READ D
2530  IF (R1>D) GOTO 2515
2535  DATA 6,11,13,15,17,22,32,35,37,42,44,54,64,69,95
2537  IF (D1>10) GOTO 2545
...
2940  IF (C>(22+RAN(4))) GOTO 2955
2945  PRINT "DON'T ";
2950  C1=1
2955  PRINT "HAVE ENOUGH CLOTHING TO KEEP YOU WARM"
2960  IF (C1=0) GOTO 3100
2965  GOTO 4700
...
2980  M1=M1-4-RAN(3)
2985  GOTO 3100
2990  IF (E=1) GOTO 4700
2995  IF (E=3) GOTO 3010
3000  IF (RAN(100)>25) GOTO 4700
3005  GOTO 3100
3010  IF (RAN(100)<50) GOTO 4700
3015  GOTO 3100
3020  PRINT "HELPFUL INDIANS SHOW YOU WHERE TO FIND MORE FOOD"
3025  F=F+14
3030  GOTO 3100
3099  REM ***MOUNTAINS***
3100  IF (M <= 950) GOTO 700
3105  IF (RAN(10)>(9-((M/100-15)^2+72)/((M/100-15)^2+12))) GOTO 3175
3110  PRINT "RUGGED MOUNTAINS"
3115  IF (RAN(100)>10) GOTO 3135
3120  PRINT "YOU GOT LOST---LOSE VALUABLE TIME TRYING TO FIND TRAIL!"
3125  M=M-60
3130  GOTO 3175
3135  IF (RAN(100)>11) GOTO 3160
...
3165  M=M-45-RAN(100)/2
3175  IF (F1=1) GOTO 3195
3180  F1=1
3185  IF (RAN(100)<80) GOTO 3300
3190  PRINT "YOU MADE IT SAFELY THROUGH SOUTH PASS--NO SNOW"
3195  IF (M<1700) GOTO 3215
3200  IF (F2=1) GOTO 3215
3205  F2=1
3210  IF (RAN(100)<70) GOTO 3300
3215  IF (M>950) GOTO 700
3220  M9=1
3225  GOTO 700
...
4007  X$=INKEY$
4010  CLEAR SCREEN
4012  REM *no BELLS IN LINES 4015, 4020*
...
4115  GOTO 4125
4120  PRINT "SUNDAY ";
4125  IF (D3>124) GOTO 4145
4130  D3=D3-93
4135  PRINT "JULY ",D3," 1847"
4140  GOTO 4215
4145  IF (D3>155) GOTO 4165
4150  D3=D3-124
4155  PRINT "AUGUST ",D3," 1847"
4160  GOTO 4215
4165  IF (D3>185) GOTO 4185
4170  D3=D3-155
4175  PRINT "SEPTEMBER ",D3," 1847"
4180  GOTO 4215
4185  IF (D3>216) GOTO 4205
4190  D3=D3-185
...
4230  IF (B>0) GOTO 4240
4235  B=0
4240  IF (C>0) GOTO 4250
4245  C=0
4250  IF (M1>0) GOTO 4260
4255  M1=0
4260  IF (T>0) GOTO 4270
4265  T=0
4270  IF (F>0) GOTO 4285
4275  F=0
4285  PRINT STR$(F,"######"),"  ",STR$(B,"######"),"   ",STR$(C,"######"),"     ",STR$(M1,"######")," ",STR$(T,"######")
4290  PRINT
...
4502  BEEP
4505  B2=7
4510  B1=val(mid$(time$,10))
4515  INPUT C$
4517  B1=val(mid$(time$,10))-B1
4518  IF (B1 > B2) B1=B2
4520  PRINT
4525  IF (C$="BANG") GOTO 4535
4530  B1=B2
4535  RETURN
4699  REM ***ILLNESS SUB-ROUTINE***
4700  IF (RAN(100)<(10+35*(E-1))) GOTO 4740
4705  IF (RAN(100)<(100-(40/4^(E-1)))) GOTO 4760
...
4765  M=M-5
4770  M1=M1-5
4780  IF (M1<0) GOTO 3550
4785  IF (L1=1) GOTO 3215
4790  GOTO 3100
